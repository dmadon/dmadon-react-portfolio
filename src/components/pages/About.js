...
function About(){
    ...
    <motion.section 
      ...
      <article>
        ...
        <p >After working the last fifteen years in a clerical support role, I decided to take on a new challenge by making a career change and entering the software development world. I hold a professional certificate in Full Stack Web Development, which I earned through SMU's Full Stack Web Development boot camp. 
